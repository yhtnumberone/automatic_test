...
from testcases.business_flow.order_manage_pq import OrderFlow
...
test1 = [OrderFlow('test_create_order_flow')]
suite = unittest.TestSuite()
suite.addTests(test1)
BeautifulReport(suite).report(filename=report_name, description='订单流程', log_path=report_path)
